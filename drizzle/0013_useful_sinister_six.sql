...
ALTER TABLE `anime` ADD `embedding_text` text;--> statement-breakpoint
ALTER TABLE `books` ADD `embedding_text` text;--> statement-breakpoint
ALTER TABLE `games` ADD `embedding_text` text;--> statement-breakpoint
ALTER TABLE `manga` ADD `embedding_text` text;--> statement-breakpoint
ALTER TABLE `movies` ADD `embedding_text` text;--> statement-breakpoint
ALTER TABLE `series` ADD `embedding_text` text;