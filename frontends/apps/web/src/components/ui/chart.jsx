...
const ChartTooltipContent = React.forwardRef((
    ...
    return (
        <div ref={ref} className={cn("grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-border/50 " +
            "bg-background px-2.5 py-1.5 text-xs shadow-xl", className)}>
                    ...
                    return (
                        <div
                            ...
                            className={cn("flex w-full flex-wrap items-stretch gap-2 [&>svg]:h-2.5 [&>svg]:w-2.5 " +
                                "[&>svg]:text-muted-foreground", indicator === "dot" && "items-center")}>
