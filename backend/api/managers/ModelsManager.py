...
class ModelsManager:
    """ Fetch specific models using MediaType and ModelTypes """
    ...
    ReturnModelGroup = (
        Dict[ModelTypes, Type[db.Model]] | Dict[MediaType, Type[db.Model]] |
        Dict[MediaType, Dict[ModelTypes, Type[db.Model]]]
    )
