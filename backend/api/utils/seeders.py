    ...
    return [
        ...
        AchievementData(
            ...
            tiers=[
                ...
                TierData(criteria=CriteriaData(count=15, value=8), difficulty=AchievementDifficulty.SILVER),
                TierData(criteria=CriteriaData(count=30, value=8), difficulty=AchievementDifficulty.GOLD),
                TierData(criteria=CriteriaData(count=50, value=8), difficulty=AchievementDifficulty.PLATINUM),
            ],
        ),
        AchievementData(
            ...
            media_type=MediaType.SERIES,
            tiers=[
                TierData(criteria=CriteriaData(count=1, value=150), difficulty=AchievementDifficulty.BRONZE),
                TierData(criteria=CriteriaData(count=3, value=150), difficulty=AchievementDifficulty.SILVER),
                TierData(criteria=CriteriaData(count=7, value=150), difficulty=AchievementDifficulty.GOLD),
        ...
        AchievementData(
            ...
            tiers=[
                ...
                TierData(criteria=CriteriaData(count=20, value="Comedy"), difficulty=AchievementDifficulty.SILVER),
                TierData(criteria=CriteriaData(count=40, value="Comedy"), difficulty=AchievementDifficulty.GOLD),
                TierData(criteria=CriteriaData(count=70, value="Comedy"), difficulty=AchievementDifficulty.PLATINUM),
            ],
        ),
        AchievementData(
            ...
            tiers=[
                ...
                TierData(criteria=CriteriaData(count=35, value="Drama"), difficulty=AchievementDifficulty.SILVER),
                TierData(criteria=CriteriaData(count=60, value="Drama"), difficulty=AchievementDifficulty.GOLD),
