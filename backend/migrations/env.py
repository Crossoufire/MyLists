...
# Alembic Config object. Provides access to values in .ini file in use
...
def run_migrations_online():
    ...
    # Callback used to prevent auto-migration from being generated when no changes to schema
