    ...
    return [
        {
            ...
            cards: {
                ...
                cardStatsList: [
                    ...
                    createStatCard(`Avg. Favorites / ${forUser ? "Type" : "User"}`, data.avgFavorites, `Total: ${data.totalFavorites} Favorites`),
                    createStatCard(`Avg. Comments / ${forUser ? "Type" : "User"}`, data.avgComments, `Total: ${data.totalComments} Comments`),
                    createStatCard("Avg. Updates / Month", data.updatesPerMonth.avgUpdates, `Total: ${data.updatesPerMonth.totalUpdates} Updates`),
