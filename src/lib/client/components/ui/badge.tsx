    ...
    " transition-[color,box-shadow] overflow-hidden",
    {
        variants: {
            variant: {
                ...
                collection: "cursor-pointer border-transparent bg-green-700 text-secondary-foreground hover:bg-green-700/80 px-2.5 py-0.5 text-sm",
                collectionToAdd: "cursor-pointer border-transparent bg-cyan-700 text-secondary-foreground hover:bg-cyan-700/80 px-2.5 py-0.5 text-sm",
