    ...
    return (
        <input
            ...
            className={cn(
                ...
                "shadow-xs transition-[color,box-shadow] outline-hidden file:inline-flex file:h-7 file:border-0 file:bg-transparent " +
                "file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 " +
                "md:text-sm", "focus-visible:ring-app-accent focus-visible:ring-1",
