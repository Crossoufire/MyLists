...
import type {UserMediaWithLabels} from "@/lib/types/base.types";
...
describe("MoviesService", async () => {
    ...
    const makeUserState = (overrides: Partial<UserMediaWithLabels<MoviesList>>): UserMediaWithLabels<MoviesList> => ({
        ...makeState(overrides),
        labels: [],
