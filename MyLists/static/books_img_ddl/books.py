...
import sys, time, os, argparse, ssl, datetime, json, re, codecs, socket, secrets
...
class GoogleImages(object):
    ...
    def build_search_url(self, search_term, params):
    ...
    def download_image(self, image_url, main_directory):
        try:
            ...
            try:
                ...
                if type == "image/jpeg" or type == "image/jpg":
                    ...
                    return "fail", f"Skipping this invalid image format: {type}.", "", ""
