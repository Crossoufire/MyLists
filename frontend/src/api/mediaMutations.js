...
const updateMediaMap = {
    ...
    update_chapter: (media, value) => ({ ...media, current_chapter: value }),
...
export const useMediaMutations = (mediaType, mediaId, queryKey) => {
    ...
    const updateChapter = createMediaMutation("update_chapter", mediaType, mediaId, queryKey);
    ...
    return {
        updateRating, updateComment, updateFavorite, updateRedo, updatePlaytime, updatePage, updateChapter,
        updatePlatform, updateSeason, updateEpisode, addToList, removeFromList, updateStatusFunc,
    };
};
