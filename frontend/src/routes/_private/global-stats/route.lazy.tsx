...
function GlobalStatsPage() {
    const apiData: GlobalStatsApiData = useSuspenseQuery(globalStatsOptions()).data;
...
const GlobalTopMediaItem = ({title, dataToMap, asFloat = false}: GlobalTopMediaItemProps) => {
    return (
...
interface GlobalStatsApiData {
    ...
    total_seasons: {
        series: Array<{ seasons: number, episodes: number }>;
        anime: Array<{ seasons: number, episodes: number }>;
    };
    nb_media: {
        series: number;
        anime: number;
    ...
    top_media: {
        series: Array<{ info: string, quantity: number }>;
        anime: Array<{ info: string, quantity: number }>;
        movies: Array<{ info: string, quantity: number }>;
        books: Array<{ info: string, quantity: number }>;
        games: Array<{ info: string, quantity: number }>;
    };
    top_genres: {
        series: Array<{ info: string, quantity: number }>;
        anime: Array<{ info: string, quantity: number }>;
...
interface GlobalTopMediaItemProps {
    title: string;
    dataToMap: Array<{ info: string, quantity: number }>;
    asFloat?: boolean;
}