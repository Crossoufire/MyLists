...
interface TrendsApiData {
    tv_trends: Array<MediaTrends>;
    movies_trends: Array<MediaTrends>;
}


interface MediaTrends {
    api_id: number;
    poster_path: string;
    display_name: string;
    release_date: string;
    overview: string;
    media_type: "series" | "movies";
}


export const Route = createLazyFileRoute("/_private/trends")({
...
function TrendsPage() {
    ...
    const apiData: TrendsApiData = useSuspenseQuery(trendsOptions()).data;
...
const TrendItem = ({media}: MediaTrends) => {
    return (
