...
export const NavMediaDrop = ({ currentUser }) => {
    ...
    const menuItems = [
        ...
        {url: `/list/anime`, media: "anime", cond: userClient.getMediaSettings("anime").active},
        {url: `/list/movies`, media: "movies"},
        {url: `/list/books`, media: "books", cond: userClient.getMediaSettings("books").active},
        {url: `/list/games`, media: "games", cond: userClient.getMediaSettings("games").active},
    ];
