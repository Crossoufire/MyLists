...
import {MediaType, User} from "@/utils/types";
...
export const GlobalStats = ({userData, global}: GlobalStatsProps) => {
    ...
    const transformToPieData = (global: GlobalStatsProps["global"]): Array<PieDataItem> => {
                    ...
                    <div className="col-span-12 sm:col-span-5">
                        <div className="flex items-center h-[180px]">
                            <ResponsivePie
                                ...
                                arcLabel={(d) => (d.data as PieDataItem).total}
                                margin={{top: 10, right: 10, bottom: 10, left: 10}}
                                borderColor={{from: "color", modifiers: [["darker", 3.0]] as any}}
                            />
                        </div>
                    </div>
...
interface GlobalStatsProps {
    ...
    global: {
        ...
        media_types: Array<MediaType>;
        time_per_media: Array<number>;
        count_per_feeling: Array<number>;
    }
}
