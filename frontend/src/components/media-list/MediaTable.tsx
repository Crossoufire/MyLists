...
export const MediaTable = ({isCurrent, mediaType, mediaList, pagination, queryKey, onChangePage}: MediaTableProps) => {
...
function getColumnWidth(colId: string): string {
    const columnWidths = {
        "Name": "auto",
        "status": "auto",
        "Progress": "auto",
