...
export const FiltersSideSheet = ({isCurrent, onClose, allStatus, onFilterApply}: FiltersSideSheetProps) => {
    let localFilters = {};
...
interface SearchFilterProps {
    job: string;
    dataList: Array<any>;
    registerChange: (value1: any, value2: any) => void;
}