...
import {MediaType, Rating} from "@/utils/types";
...
function PlatformDrop({platform, allPlatforms, updatePlatform}: PlatformDropProps) {
...
const PlatformComboBox = ({resetValue = "", dataList, callback, isPending}: PlatformComboBoxProps) => {
...
interface GamesUserDetailsProps {
    ...
    userMedia: {
        ...
        platform: string;
        playtime: number;
        all_status: Array<string>;
        all_platforms: Array<string>;
        rating: { type_: Rating; value: number };
    };
}


interface PlatformDropProps {
    platform: string;
    allPlatforms: Array<string>;
    updatePlatform: UseMutationResult;
}
