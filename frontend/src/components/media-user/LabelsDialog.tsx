...
export const LabelsDialog = ({mediaId, mediaType, mediaLabels, updateMediaLabels}: LabelsDialogProps) => {
    ...
    const renameMediaLabel = () => {
        ...
        renameLabel.mutate({oldName: oldName, newName: editedLabelName}, {
            ...
            onSuccess: () => {
                ...
                queryClient.setQueryData(["labels", mediaType], (oldData: Array<any>) => {
...
interface LabelsDialogProps {
    mediaId: number;
    mediaType: MediaType;
    mediaLabels: Array<string>;
    updateMediaLabels: (value: any) => void;
}
