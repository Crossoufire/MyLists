...
export const EpsSeasonsDrop = ({currentSeason, currentEpisode, epsPerSeason, updateSeason, updateEpisode}: EpsSeasonsDropProps) => {
...
interface EpsSeasonsDropProps {
    currentSeason: number;
    currentEpisode: number;
    epsPerSeason: Array<number>;
    updateSeason: UseMutationResult;
    updateEpisode: UseMutationResult;
}