...
export const HomePage = () => {
	return (
		<PageTitle title="HomePage" onlyHelmet>
			<div className="relative bg-cover h-[800px] w-lvw left-[calc(-50vw+50%)]" style={{backgroundImage: `url(${homeImage})`}}/>
					...
					<div className="p-2">
						<div className="flex flex-col">
							...
							<p className="ml-14">
								...
								<a href="https://www.github.com/Crossoufire/MyLists" target="_blank" rel="noreferrer">Github</a>.
							</p>
						</div>
					</div>
					<div className="p-2">
